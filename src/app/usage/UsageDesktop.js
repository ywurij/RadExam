        ...
        <div style={{
            ...
            <div style={{ background: 'var(--surface-raised)', border: '1px solid var(--border-color)', borderRadius: '0.75rem', padding: '1.4rem', marginBottom: '2.5rem' }}>
                ...
                <ul style={{ margin: 0, paddingLeft: '1.35rem', color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
                    ...
                    <li>「クラウド暗号化」を有効にすると、問題文・解説・進捗・画像・PDFは送信前に暗号化されます。別端末では同じ同期パスフレーズを入力してください。</li>
                    <li>同期パスフレーズは端末にもクラウドにも保存されません。紛失するとクラウドデータを復元できないため、安全なパスワード管理アプリ等へ保管してください。</li>
                    <li>緊急復旧に備え、データ管理からパスワード付き.radexamバックアップも定期的に保存してください。パスワードを紛失すると復元できません。</li>
                    <li>共有端末では「データ管理 / バックアップ」のアプリロックを設定できます。これは画面の覗き見を防ぐ機能で、端末内ファイル自体を暗号化する機能ではありません。</li>
                </ul>
            </div>
            ...
            <div style={{
                ...
                <p style={{ margin: 0, color: 'var(--warning-text)' }}>
                    「試験管理」の「<b>データ管理 / バックアップ</b>」にある「<b>パスワード付きでエクスポート</b>」から、定期的にRadExamバックアップ（.radexam）を保存してください。試験データ、画像、登録元PDF、学習進捗が対象です。「<b>インポート (完全復元)</b>」で別のPCへ移行できます。従来の暗号化されていない.radexamも引き続き読み込めます。
                </p>
            </div>
