        ...
        <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', marginBottom: '2.5rem' }}>
                ...
                <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: '0.92rem', color: 'var(--text-secondary)' }}>
                        放射線科専門医、放射線診断専門医、放射線治療専門医、核医学専門医、IVR専門医から対象を選択し、同じ試験の複数年度PDFをまとめて読み込みます。<br />
                ...
                <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: '0.92rem', color: 'var(--text-secondary)' }}>
                        自動抽出された問題文、選択肢、画像、レジェンドを一覧で確認します。画像は追加・削除・表示順変更が可能です。核医学は「巻末図ページを参照」する方式で、問題文中の別紙番号に対応する巻末ページを表示します。<br />
            ...
            <div style={{ background: 'var(--surface-raised)', border: '1px solid var(--border-color)', borderRadius: '0.75rem', padding: '1.4rem', marginBottom: '2.5rem' }}>
                ...
                <ul style={{ margin: 0, paddingLeft: '1.35rem', color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
                    ...
                    <li>緊急復旧に備え、データ管理から.radexamバックアップも定期的に保存してください。</li>
                </ul>
            </div>
            ...
            <div style={{
                ...
                <p style={{ margin: 0, color: 'var(--warning-text)' }}>
                    「試験管理」の「<b>データ管理 / バックアップ</b>」にある「<b>バックアップをエクスポート</b>」から、定期的にRadExamバックアップ（.radexam）を保存してください。試験データ、画像、登録元PDF、学習進捗が対象です。「<b>インポート (完全復元)</b>」で別のPCへ移行できます。
                </p>
            </div>
