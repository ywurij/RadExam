...
- モバイル版のOneDrive認証が同じ画面を繰り返す問題を修正し、認証後の接続を安定させました。
- モバイル版でOneDriveからファイルを取得できない場合がある問題を修正しました。
- MIT Licenseを追加し、プライバシーポリシー、利用規約、お問い合わせページをMac/PC版とモバイル版へ追加しました。
- 公開物に不要な開発用画像を含めないよう整理しました。
